...
def set_network_access_true(config_text: str) -> str:
    return _set_network_access(True, config_text=config_text)
...
def install_hook(
    *,
    ...
    del require_network_check, no_overwrite, delete_existing_tokens
    return install(interactive=interactive, force=force)


def remove_hook(*, force: bool = False, interactive: bool = True, delete_tokens: bool = False) -> int:
    return uninstall(force=force, interactive=interactive, delete_credentials=delete_tokens)
